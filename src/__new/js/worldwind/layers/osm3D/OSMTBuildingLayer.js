 ...
 */
define(['./OSMBuildingLayer',
        './GeoJSONParserTriangulationOSM',

        'jquery',
        'worldwind'],
    function (OSMBuildingLayer,
              GeoJSONParserTriangulationOSM,

              $) {
        "use strict";

        var MemoryCache = WorldWind.MemoryCache;
        var BoundingBox = WorldWind.BoundingBox;
        var Sector = WorldWind.Sector;
        var GestureRecognizer = WorldWind.GestureRecognizer;
        var DragRecognizer = WorldWind.DragRecognizer;
        var PanRecognizer = WorldWind.PanRecognizer;
        var ClickRecognizer = WorldWind.ClickRecognizer;
        var TapRecognizer = WorldWind.TapRecognizer;
        var PinchRecognizer = WorldWind.PinchRecognizer;
        var RotationRecognizer = WorldWind.RotationRecognizer;
        var TiltRecognizer = WorldWind.TiltRecognizer;
        var GeoJSONFeature = WorldWind.GeoJSONFeature;
