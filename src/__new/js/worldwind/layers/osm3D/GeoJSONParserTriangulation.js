...
define(['earcut',
    ...
    function (earcut) {
        "use strict";
        var GeoJSONParser = WorldWind.GeoJSONParser;
        var Position = WorldWind.Position;
        var TriangleMesh = WorldWind.TriangleMesh;
        ...
        GeoJSONParserTriangulation.prototype.lateralSurfaces = function (configuration, altitude, boundaries) {
            var points = [], positions = [], indices = [], longitude_0, latitude_0, reprojectedCoordinate_0,
