...
export default utils.deepKeyMirror({
	...
	MAPS: {
		...
		SET_SCOPE: 'SET_MAP_SCOPE',
		SET_SCENARIO: 'SET_MAP_SCENARIO',
		SET_PERIOD: 'SET_MAP_PERIOD',
		SET_PLACE: 'SET_MAP_PLACE',
		SET_CASE: 'SET_MAP_CASE',
		SET_BACKGROUND_LAYER: 'SET_MAP_BACKGROUND_LAYER',
		SET: {
			ADD: 'ADD_SET',
			REMOVE: 'REMOVE_SET',
			ADD_MAP: 'ADD_MAP_TO_SET',
			REMOVE_MAP: 'REMOVE_MAP_KEY_FROM_SET',
			SET_WORLD_WIND_NAVIGATOR_SYNC: 'SET_SET_WORLD_WIND_NAVIGATOR_SYNC',
		},
		MAP: {
			ADD: 'ADD_MAP',
			REMOVE: 'REMOVE_MAP',
			SET_NAME: 'SET_MAP_NAME',
			SET_DATA: 'SET_MAP_DATA',
			SET_WORLD_WIND_NAVIGATOR: 'SET_MAP_WORLD_WIND_NAVIGATOR',
		},
		LAYERS: {
			ADD_LAYER: 'ADD_LAYER',
