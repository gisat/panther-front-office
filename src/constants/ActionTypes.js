...
export default utils.deepKeyMirror({
	...
	MAPS: {
		SET_ACTIVE_MAP_KEY: 'SET_ACTIVE_MAP_KEY',
		ADD_SET: 'ADD_SET',
		REMOVE_SET: 'REMOVE_SET',
		ADD_MAP_TO_SET: 'ADD_MAP_TO_SET',
		REMOVE_MAP_KEY_FROM_SET: 'REMOVE_MAP_KEY_FROM_SET',
		SET_SET_WORLD_WIND_NAVIGATOR_SYNC: 'SET_SET_WORLD_WIND_NAVIGATOR_SYNC',
		ADD_MAP: 'ADD_MAP',
		REMOVE_MAP: 'REMOVE_MAP',
		SET_MAP_NAME: 'SET_MAP_NAME',
		SET_MAP_DATA: 'SET_MAP_DATA',
		SET_MAP_WORLD_WIND_NAVIGATOR: 'SET_MAP_WORLD_WIND_NAVIGATOR',
		ADD_LAYER: 'ADD_LAYER',
		ADD_LAYERS: 'ADD_LAYERS',
		REMOVE_LAYER: 'REMOVE_LAYER',
		REMOVE_LAYERS: 'REMOVE_LAYERS',
		SET_LAYER_INDEX: 'SET_LAYER_INDEX',
		UPDATE_MAP_LAYER: 'UPDATE_MAP_LAYER',
		SET_MAP_SCOPE: 'SET_MAP_SCOPE',
		SET_MAP_SCENARIO: 'SET_MAP_SCENARIO',
		SET_MAP_PERIOD: 'SET_MAP_PERIOD',
		SET_MAP_PLACE: 'SET_MAP_PLACE',
		SET_MAP_CASE: 'SET_MAP_CASE',
		SET_MAP_BACKGROUND_LAYER: 'SET_MAP_BACKGROUND_LAYER',
	},
