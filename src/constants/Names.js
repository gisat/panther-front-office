export default {
	...
	SCENARIO_MAP_EDITING_CLOSE_MESSAGE: 'Do you really want to close editing and discard all changes?',
	SCENARIO_MAP_EDITING_SAVE_MESSAGE: 'Do you really want to save all changes and create a new scenario?',
