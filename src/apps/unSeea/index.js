...
const WINDOW_SET_KEY = "un_seea";
const MAP_SET_KEY = "un_seea_mapset";

export default (path, baseUrl) => {

	Store.dispatch(Action.views.add(viewCfg));
	Store.dispatch(Action.views.setActiveKey('UN_SEEA'));
	Store.dispatch(Action.views.apply("UN_SEEA", Action));
	...
	Store.dispatch(Action.spatialDataSources.vector.addBatchIndex(spatialdataindexFilter, null, [{spatialDataSourceKey: "un_seea_boundaries"}], 'spatialDataSourceKey'));
