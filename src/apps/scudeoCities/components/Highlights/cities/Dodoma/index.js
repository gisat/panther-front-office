...
const au_2_attributes_serial = conversions.featuresToAttributesSerial(au_2_data, 'AL2_ID', [
...
const au_2_serial_as_object = conversions.featuresToSerialDataAsObject(au_2_data)[1];
const au_3_serial_as_object = conversions.featuresToSerialDataAsObject(au_3_data);

const au_2_lulc_1_changes = conversions.getAttributeChanges(au_2_data, 'AL2_ID', [
