				...
				<div>
					<div className="ptr-fuore-landing-page-intro">
						...
						<div className="ptr-fuore-landing-page-text">
							...
							<span className="bottom-link"><a href="https://www.espon.eu/" target="_blank">Project information</a></span>
							<span className="bottom-link"><a href="#" target="_blank">Guidance materials</a></span>
						</div>
					</div>
					<ScopesList/>
