		...
		return (
			<div className="esponFuore-scopes-description">
				...
				<div className="esponFuore-scopes-description-content">
					...
					<a href="https://www.espon.eu/sites/default/files/attachments/GRETA_Final%20Report.pdf" target="_blank">More details on the ESPON GRETA Final Report, pp. 35-45</a>.
