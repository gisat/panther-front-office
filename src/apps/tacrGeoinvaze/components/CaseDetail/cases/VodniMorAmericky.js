...
const VodniMorAmericky = props => (
	<div>
		...
		<TextBlock>
			...
			<p>Hydrofyt, anemofil, hydrochor, K-stratég. Osidluje tekoucí i stojaté vody, zejména mezotrofní, průhledné, s nižším obsahem živin (významný rozdíl proti <i>E. canadensis</i> která preferuje eutrofní vody s významným podílen vápníku). Přezimuje pomocí turionů, snadno se šíří fragmentací lodyh. </p>
		</TextBlock>
		<InvasivePotential>
		...
		<Resources>
			<Resource>Cook, C. D., Urmi-König, K. (1985). A revision of the genus <i>Elodea</i> (Hydrocharitaceae). Aquatic Botany, 21(2), 111-156.</Resource>
			<Resource>Greulich, S.,Tremolieres, M. (2006). Present distribution of the genus Elodea in the Alsatian Upper Rhine floodplain (France) with a special focus on the expansion of <i>Elodea nuttallii</i> St. John during recent decades. Hydrobiologia, 570(1), 249-255.</Resource>
