...
const Nutrie = props => (
	<div>
		...
		<Resources>
			...
			<Resource>
				Anděra M., Červený J., 2004: Atlas rozšíření savců v České republice. Předběžná verze IV. Hlodavci (<i>Rodentia</i>) - část 3 Veverkovití (<i>Sciuridae</i>), bobrovití (<i>Castorodae</i>), nutriovití (<i>Myocastoridae</i>). Národní muzeum, Praha,76 pp.
			</Resource>
			<Resource>
