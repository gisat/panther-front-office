...
const KorbikulaAsijska = props => (
	<div>
		...
		<Summary>
			...
			<SecondaryArea text="Postupně osídlila téměř celou Evropu. Introdukována (balastní vodou) i do Severní Ameriky.  Vyskytuje se také v Africe, Austrálii a Jižní Americe. Na naše území pronikla Labem z Německa a postupně expandovala proti proudu do středních Čech. Detekována také v dolním toku Vltavy (po Prahu, včetně plavebního kanálu Vraňany – Hořín) a Ohře (po Terezín). Pozorována v ně¬kterých menších přítocích Labe, jakým je např. potok Vlkava u Kostomlat nad La¬bem. Od r. 2009 je sledována neobvyklá lokalita na rozhraní středních a severních Čech, kde korbikula dosahuje zatím největší známé koncentrace na našem území. Jde o betonový kanál vedoucí mírně oteplenou vodu z od¬kališť Elektrárny Mělník do Labe jižně od obce Horní Počaply. Lze předpokládat další šíření, a to jak ve vlastním Labi, tak i do jeho větších přítoků. Zároveň nelze vyloučit invazi Dunajem ze Slovenska na naše území. Očekává se její postupné objevení na řece Moravě a Dyji. "/>
