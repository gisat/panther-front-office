...
const PajasanZlaznaty = props => (
	<div>
		...
		<Summary>
			...
			<SecondaryArea text="V roce 1784 byla evropská semena pajasanu dovezena do Severní Ameriky, rovněž vysazován v severní Africe, Střední a Jižní Americe, Austrálii a na Novém Zélandě, na tichomořských i atlantických ostrovech. Na naše území patrně dovezen na konci 18. století, kdy byl vysazen na jižní Moravě v lesních školkách lednického panství Lichtensteinů. Plně ověřený je pak údaj z roku 1865 (Hluboká). Vyskytuje zejména v teplých oblastech s centrem na jižní Moravě a v Polabí. Dále roste např. v Podyjí a jeho okolí. Vzhledem k vysazování pajasanu a jeho dobré schopnosti šíření se očekává invaze do dalších lokalit."/>
