...
const KustovniceCizi = props => (
	<div>
		...
		/>
		<TextBlock>
			<p>Kustovnice cizí je opadavý samosprašný keř až polokeř dorůstající výšky 1—3 m.  Má obloukovitě prohnuté větve. Listy jsou jednoduché střídavé, sivé, variabilního tvaru. Kvete od května do září růžově fialovými květy. Kalich má dva cípy, dosahuje minimálně do 2/3 délky korunní trubky. Tyčinky jsou na bázi chlupaté. Plodem jsou oranžové vejcovité bobule.  Celá rostlina je slabě až středně jedovatá.</p>
