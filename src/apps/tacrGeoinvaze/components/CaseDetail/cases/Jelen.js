...
const Jelen = props => (
	<div>
		...
		/>
		<TextBlock>
			<p>U nás rozšířený sika je považován za poddruh označovaný jako sika japonský (<i>C. n. nippon</i>). Tělo má až 145 cm dlouhé, ocas 25 cm, výška v kohoutku je 95 cm a hmotnost 55 kg. Stejně jako u jiných jelenovitých jsou i u tohoto druhu laně výrazně menší než jeleni. Kdysi se k nám dovážel i poněkud větší sika Dybowského (<i>C. n. dybowskii</i>, syn. <i>C. n. hortulorum</i>), takže je jisté, že se oba poddruhy mezi sebou křížily. Tvarem těla je sika dosti podobný jelenu evropskému. Letní srst má kaštanově hnědou s bílými skvrnami a tmavým pruhem na hřbetě. V zimním šedohnědém až téměř černém zbarvení je skvrnění nevýrazné. Tmavý ocas kontrastuje s bílým obřitkem. Samcům vyrůstá poměrně jednoduché paroží a v době říje mají krátkou hřívu. Sika sice není v Evropském seznamu nepůvodních invazních druhů, je ale uveden na Seznamu prioritních invazních druhů ČR (tzv. černý seznam). Myslivecká legislativa tento druh řadí mezi zvěř se stanovenou dobou lovu. </p>
		...
		<Resources>
			...
			<Resource>Anděra M., Červený J. 2009: Velcí savci v České republice. Rozšíření, historie a ochrana. 1. Sudokopytníci (<i>Artiodactyla</i>). Národní muzeum, Praha, 87 pp.</Resource>
