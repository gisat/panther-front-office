...
const Astra = props => (
	<div>
		...
		/>
		<TextBlock>
			<p>Vytrvalá, 0,4–1,2(–1,4) m vysoká bylina s podzemními výběžky; lodyhy jsou přímé a lysé. Listy celokrajné až ostře pilovité, jsou střídavé, obkopinaté až eliptické, až 20 cm dlouhé a 4 cm široké, zejména horní přisedlé a oušky na bázi objímající lodyhu. Lodyha v horní části s rozvětveným početným modrým vzácněji bělavým květenstvím až 3 cm velkých úborů, s 3 - 4 řadým zákrovem, 30–50 jazykovitých květů, terč je žlutý. Plody jsou chlupaté nažky asi 2 mm dlouhé, s 5—6 mm dlouhým chmýrem. Názory na taxonomické uspořádání aster se různí. Druhy jsou šlechtěny do různých kultivarů (včetně metod hybridizace). Poté, co se začaly šířit po Evropě, vznikly komplikace s přiřazením různých odlišných typů k původně popsaným mateřským druhům.</p>
