...
// add local locales
localesUtils.addI18nResources('PlaceMetadataConfig', {cz, en});
		...
		return (
			<div>
				...
				>
					...
					/>
					<InputWrapperInfo>{t("PlaceMetadata:geometryDescription")}</InputWrapperInfo>
				</InputWrapper>
				<InputWrapper
...
export default withNamespaces(['backOffice', 'PlaceMetadata'])(PlaceConfig);