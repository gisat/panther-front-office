...
import PlaceWmsMapsTimeline from './PlaceWmsMapsTimeline';
...
const mapStateToProps = state => {
	return {
		...
		layers: Select.wmsLayers.getLayersWithPlacePeriods(state)
	}
};
...
export default connect(mapStateToProps, mapDispatchToProps)(PlaceWmsMapsTimeline);