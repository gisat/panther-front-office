// Karma configuration
// Generated on Wed Feb 10 2016 13:33:54 GMT+0100 (Střední Evropa (běžný čas))
...
module.exports = function (config) {
    config.set({
        ...
        files: [
            ...
            {pattern: 'src/__new/js/stores/*.js', included: false},
            {pattern: 'src/__new/js/util/*.js', included: false},
            {pattern: 'src/__new/js/util/histogram/*.js', included: false},
            {pattern: 'src/__new/js/util/metadata/*.js', included: false},
